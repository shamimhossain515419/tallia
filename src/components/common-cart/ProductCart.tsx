          ...
          <div>
               ...
               >
                    <div className="group">
                         ...
                         <h1 className="text-[#7a7a7a]  opacity-0 group-hover:opacity-100  duration-500  text-[18px] font-medium  text-center py-3 uppercase ">
                              {name ? name : "VIRON OLIVE/RUST SPORT COA"}
                         </h1>
                    </div>
               </div>
